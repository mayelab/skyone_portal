...
RUN R -e "install.packages(c('shinyWidgets', 'shinydashboard', 'dplyr', 'rvest', 'leaflet', 
'stringr', 'sf', 'shinybusy', 'RMySQL', 'DBI', 'shinyjs', 'blastula', 'httr',
'aws.s3', 'base64enc', 'colorspace', 'waypointer'), repos='https://cloud.r-project.org/')"
